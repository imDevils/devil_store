...
<body>
<!--main_top-->
<table width="99%" border="0"  id="searchmain">
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0"  id="main-tab">
      <tr>
	  ...
	  <?php if(is_array($info)): foreach($info as $key=>$user): ?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($user["qx"]); ?></td>
		<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($user["email"]); ?></td>
        <td align="center" valign="middle" class="borderright borderbottom"><?php echo ($user["logintime"]); ?></td>
        <td align="center" valign="middle" class="borderbottom">
		<a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">编辑</a>
		<span class="gray">&nbsp;|&nbsp;</span>
		<a href="/ThinkPHP/chuwei/admin.php/index/delete?id=<?php echo ($user["id"]); ?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr><?php endforeach; endif; ?>
    </table></td>
    </tr>
  <tr>
    <td align="left" valign="top" class="fenye">共 <?php echo ($info2); ?> 条数据 1/1 页&nbsp;&nbsp;<a href="#" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;<a href="#" target="mainFrame" onFocus="this.blur()">上一页<?php echo ($page1); ?></a>&nbsp;&nbsp;<a href="#" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;<a href="#" target="mainFrame" onFocus="this.blur()">尾页</a></td>
  </tr>
</table>
</body>
</html>